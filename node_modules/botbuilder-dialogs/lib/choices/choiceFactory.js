...
class ChoiceFactory {
    ...
    static heroCard(choices = [], text = '', speak = '') {
        ...
        const attachment = botbuilder_core_1.CardFactory.heroCard(null, text, null, buttons);
        return botbuilder_core_1.MessageFactory.attachment(attachment, null, speak, botbuilder_core_1.InputHints.ExpectingInput);
    }
    /**
