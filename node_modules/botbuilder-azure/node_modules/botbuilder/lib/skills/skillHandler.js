...
class SkillHandler extends channelServiceHandler_1.ChannelServiceHandler {
    ...
    processActivity(claimsIdentity, conversationId, replyToActivityId, activity) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const activityConversationReference = botbuilder_core_1.TurnContext.getConversationReference(activity);
            /**
            ...
            const callback = (context) => __awaiter(this, void 0, void 0, function* () {
                ...
                activity = botbuilder_core_1.TurnContext.applyConversationReference(activity, skillConversationReference.conversationReference);
            ...
            botframework_connector_1.AppCredentials.trustServiceUrl(skillConversationReference.conversationReference.serviceUrl);
            yield this.adapter.continueConversation(skillConversationReference.conversationReference, skillConversationReference.oAuthScope, callback);
            return { id: uuid() };
        });
    }
}
