 ...
 */
import { Activity, CoreAppCredentials, BotAdapter, ChannelAccount, ConversationReference, ConversationsResult, ExtendedUserTokenProvider, ResourceResponse, TokenResponse, TurnContext } from 'botbuilder-core';
import { AuthenticationConfiguration, ClaimsIdentity, ConnectorClient, AppCredentials, SimpleCredentialProvider, TokenApiClient, TokenStatus, SignInUrlResponse, TokenExchangeRequest } from 'botframework-connector';
 ...
 * ```
 */
export declare class BotFrameworkAdapter extends BotAdapter implements ExtendedUserTokenProvider, RequestHandler {
