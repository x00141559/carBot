...
class BotFrameworkAdapter extends botbuilder_core_1.BotAdapter {
    ...
    continueConversation(reference, oAuthScopeOrlogic, logic) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (credentials.oAuthScope !== audience) {
                ...
                credentials = yield this.buildCredentials(this.credentials.appId, audience);
            }
    ...
    processActivity(req, res, logic) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                else if (request.deliveryMode === botbuilder_core_1.DeliveryModes.ExpectReplies) {
    ...
    createConnectorClientWithIdentity(serviceUrl, identity) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const oAuthScope = yield this.getOAuthScope(botAppId, identity.claims);
    ...
    createConnectorClientInternal(serviceUrl, credentials) {
        ...
        return new botframework_connector_1.ConnectorClient(credentials, { baseUri: serviceUrl, userAgent: exports.USER_AGENT });
    }
    /**
     * @private
    ...
    */
    authenticateRequest(request, authHeader) {
        return __awaiter(this, void 0, void 0, function* () {
            const claims = yield this.authenticateRequestInternal(request, authHeader);
...
function abortWebSocketUpgrade(socket, code, message) {
    if (socket.writable) {
